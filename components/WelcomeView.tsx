...
export const WelcomeView: React.FC<WelcomeViewProps> = ({ onStart }) => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center animate-fadeIn">
      ...
      <p className="text-blue-600 font-bold mb-6 tracking-widest uppercase text-xs">Spielwarenmesse 2026</p>
      
      <p className="text-gray-600 mb-10 text-lg">
        Scatta una foto allo stand, condividila e ricevi subito il tuo 
      ...
      <div className="space-y-4 w-full mb-12">
        <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-2xl border border-gray-100">
          ...
          <p className="text-sm font-semibold text-gray-700 text-left">Foto allo stand o selfie</p>
        </div>
        <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-2xl border border-gray-100">
          <div className="bg-pink-500 p-2 rounded-lg">
            <Share2 className="w-6 h-6 text-white" />
          </div>
          <p className="text-sm font-semibold text-gray-700 text-left">Usa i tag ufficiali</p>
        </div>
      </div>
